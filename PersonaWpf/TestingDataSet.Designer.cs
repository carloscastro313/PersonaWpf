...
namespace PersonaWpf {
    ...
    public partial class TestingDataSet : global::System.Data.DataSet {
        ...
        public partial class personaDataTable : global::System.Data.TypedTableBase<personaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public personaRow AddpersonaRow(string nombre, string apellido, string dni, string legajo) {
        ...
        public partial class personaRow : global::System.Data.DataRow {
            ...
            public string legajo {
                get {
                    return ((string)(this[this.tablepersona.legajoColumn]));
                }
                set {
                    this[this.tablepersona.legajoColumn] = value;
                }
            }
        }
...
namespace PersonaWpf.TestingDataSetTableAdapters {
    ...
    public partial class personaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[persona] WHERE (([Id] = @Original_Id) AND ([nombre] = @Origina" +
                "l_nombre) AND ([apellido] = @Original_apellido) AND ([dni] = @Original_dni) AND " +
                "([legajo] = @Original_legajo))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[persona] ([nombre], [apellido], [dni], [legajo]) VALUES (@nomb" +
                "re, @apellido, @dni, @legajo);\r\nSELECT Id, nombre, apellido, dni, legajo FROM pe" +
                "rsona WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[persona] SET [nombre] = @nombre, [apellido] = @apellido, [dni] = @dni, [legajo] = @legajo WHERE (([Id] = @Original_Id) AND ([nombre] = @Original_nombre) AND ([apellido] = @Original_apellido) AND ([dni] = @Original_dni) AND ([legajo] = @Original_legajo));
SELECT Id, nombre, apellido, dni, legajo FROM persona WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PersonaWpf.Properties.Settings.Default.TestingConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, nombre, apellido, dni, legajo FROM dbo.persona";
        ...
        public virtual int Fill(TestingDataSet.personaDataTable dataTable) {
        ...
        public virtual TestingDataSet.personaDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TestingDataSet.personaDataTable dataTable = new TestingDataSet.personaDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TestingDataSet.personaDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_nombre, string Original_apellido, string Original_dni, string Original_legajo) {
            ...
            if ((Original_legajo == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((string)(Original_legajo));
            }
        ...
        public virtual int Insert(string nombre, string apellido, string dni, string legajo) {
            if ((nombre == null)) {
        ...
        public virtual int Update(string nombre, string apellido, string dni, string legajo, int Original_Id, string Original_nombre, string Original_apellido, string Original_dni, string Original_legajo, int Id) {
            if ((nombre == null)) {
                throw new global::System.ArgumentNullException("nombre");
            }
            else {
            ...
            if ((Original_legajo == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(Original_legajo));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, string apellido, string dni, string legajo, int Original_Id, string Original_nombre, string Original_apellido, string Original_dni, string Original_legajo) {
            return this.Update(nombre, apellido, dni, legajo, Original_Id, Original_nombre, Original_apellido, Original_dni, Original_legajo, Original_Id);
        }
    }
